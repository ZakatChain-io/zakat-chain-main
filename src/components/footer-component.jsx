  ...
  return (
    <>
      <div className="relative bg-[#F7F9FC] py-14 px-10 mt-3 border-b-2 border-[#E4E7EC]">
        ...
        <div
          className="absolute bottom-5 right-10 sm:top-15 sm:bottom-auto cursor-pointer"
            ...
            <form>
              <div className="flex gap-x-5">
                <input
                  ...
                  className="w-[70%] py-2 px-4 border border-[#D0D5DD] rounded-md"
                />
                <button className="bg-[#FF9606] text-white rounded py-2 px-5">
                  Subscribe
                </button>
              </div>
            </form>
